                        ...
                        <div class="row">
                            <div class="col-md-7 mx-auto">
                                <div class="mb-0 border-0 p-md-5 p-lg-0 p-4">
                                    ...
                                    <div class="pt-0">
                                        <form form method="POST" action="{{ route('register') }}" class="my-4">
                                          @csrf
                                            <div class="form-group mb-3">
                                                <label for="password" class="form-label">name</label>
                                                <input class="form-control" type="name" required="" id="name" name="name" placeholder="Enter your name">
                                            </div>
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <input class="form-control" type="password" required="" id="password_confirmation" name="password_confirmation" placeholder="Enter your password again">
                                            </div>
                                        ...
                                        <div class="text-center text-muted mb-4">
                                            <p class="mb-0">want to login?<a class='text-primary ms-2 fw-medium' href='{{route('login')}}'>signup here</a></p>
                                        </div>
