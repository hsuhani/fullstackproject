                        ...
                        <div class="row">
                            <div class="col-md-7 mx-auto">
                                <div class="mb-0 border-0 p-md-5 p-lg-0 p-4">
                                    ...
                                    <div class="pt-0">
                                        <form form method="POST" action="{{ route('login') }}" class="my-4">
                                          @csrf
                                          @if(session('error'))
...
@endif
                                        ...
                                        <div class="text-center text-muted mb-4">
                                            <p class="mb-0">dont have an account ?<a class='text-primary ms-2 fw-medium' href='{{route('register')}}'>signup here</a></p>
                                        </div>
