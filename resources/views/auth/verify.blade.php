                            ...
                            <div class="col-md-7 mx-auto">
                                <div class="mb-0 border-0 p-md-5 p-lg-0 p-4">
                                    ...
                                    <div class="pt-0">
                                        ...
                                        @endif
                                        <form form method="POST" action="{{ route('custom.verification.verify') }}" class="my-4">
                                          @csrf
                                          @if(session('error'))
...
@endif
                                            ...
                                            <div class="form-group mb-3">
                                                <label for="emailaddress" class="form-label">AUTHENTICATION CODE</label>
                                                <input class="form-control" type="text" name="code" id="code" required="" placeholder="Enterl your code ">
                                                @error('email')
