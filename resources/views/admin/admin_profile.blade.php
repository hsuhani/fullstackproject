                                            ...
                                            <div class="card border mb-0">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="form-group mb-3 row">
                                                        ...
                                                        <div class="col-lg-12 col-xl-12">
                                                            <textarea name="adress" class="form-control" >{{$profileData->adress}}</textarea>
            ...
            <div class="card border mb-0">
                ...
                <div class="card-body mb-0">
                    ...
                    <div class="form-group mb-3 row">
                        ...
                        <div class="col-lg-12 col-xl-12">
                            <input class="form-control" @error('old_password')is-invalid @enderror type="password" name="new_password_confirmation" id="new_password_confirmation" placeholder="confirm Password">
