<div class="lonyo-section-padding4">
    <div class="container">
      ...
      <div class="lonyo-faq-wrap1">
        <div class="lonyo-faq-item item2 open aos-init aos-animate" data-aos="fade-up" data-aos-duration="500">
          <div class="lonyo-faq-header">
            <h4>Is my financial data safe and secure?</h4>
            <div class="lonyo-active-icon">
              <img class="plasicon" src="{{asset('frontent/assets/images/v1/mynus.svg')}}" alt="">
              <img class="mynusicon" src="{{asset('frontent/assets/images/v1/plas.svg')}}" alt="">
            </div>
          </div>
        ...
        <div class="lonyo-faq-item item2 aos-init aos-animate" data-aos="fade-up" data-aos-duration="700">
          <div class="lonyo-faq-header">
        ...
        <div class="lonyo-faq-item item2 aos-init aos-animate" data-aos="fade-up" data-aos-duration="900">
          <div class="lonyo-faq-header">
        ...
        <div class="lonyo-faq-item item2 aos-init aos-animate" data-aos="fade-up" data-aos-duration="1100">
          <div class="lonyo-faq-header">
        ...
        <div class="lonyo-faq-item item2 aos-init aos-animate" data-aos="fade-up" data-aos-duration="1300">
          <div class="lonyo-faq-header">
