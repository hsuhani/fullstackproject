<section class="lonyo-cta-section bg-heading">
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-6">
          <div class="lonyo-default-content lonyo-cta-wrap aos-init aos-animate" data-aos="fade-up" data-aos-duration="700">
            ...
            <div class="lonyo-cta-info mt-50 aos-init aos-animate" data-aos="fade-up" data-aos-duration="900">
              <ul>
                <li>
