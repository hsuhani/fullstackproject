<div class="lonyo-section-padding position-relative overflow-hidden">
            ...
            <div class="row">
                ...
                <div class="col-xl-4 col-lg-4 d-flex align-items-center justify-content-end">
                    <div class="lonyo-title-btn">
                        <a class="lonyo-default-btn t-btn" href="{{ url('contact-us') }}">
    ...
    <div class="lonyo-testimonial-slider-init">
        ...
        <div class="lonyo-t-wrap wrap2 light-bg">
            ...
            <div class="lonyo-t-text">
                <p>"This app transformed my budgeting! It has been a clear view longer have to worry
                    of my expenses and savings goals."</p>
            </div>
        ...
        <div class="lonyo-t-wrap wrap2 light-bg">
            ...
            <div class="lonyo-t-text">
                <p>“The interface is intuitive, and I love how it syncs with my bank accounts.
                    Highly recommend!”</p>
            </div>
            <div class="lonyo-t-author">
                <div class="lonyo-t-author-thumb">
        ...
        <div class="lonyo-t-wrap wrap2 light-bg">
            ...
            <div class="lonyo-t-text">
                <p>“With this app, I’ve been able to stick to my budget and even save for a vacation.
                    The budget alerts are a game changer!”</p>
            </div>
            <div class="lonyo-t-author">
                <div class="lonyo-t-author-thumb">
        ...
        <div class="lonyo-t-wrap wrap2 light-bg">
            ...
            <div class="lonyo-t-text">
                <p>"Having all my accounts in one place gives me complete control over my money.
                    Highly recommend!"</p>
            </div>
            <div class="lonyo-t-author">
                <div class="lonyo-t-author-thumb">
        ...
        <div class="lonyo-t-wrap wrap2 light-bg">
            ...
            <div class="lonyo-t-text">
                <p>"Having all my accounts in one place gives me complete control over my money.
                    So user-friendly and helpful! Highly recommend!"</p>
            </div>
            <div class="lonyo-t-author">
                <div class="lonyo-t-author-thumb">
    ...
    <div class="lonyo-t-overlay2">
        <img src="{{ asset('frontend/assets/images/v2/overlay
