    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-xl-4 col-lg-6 col-md-6">
          <div class="lonyo-service-wrap light-bg aos-init aos-animate" data-aos="fade-up" data-aos-duration="500">
        ...
        <div class="col-xl-4 col-lg-6 col-md-6">
          <div class="lonyo-service-wrap light-bg aos-init aos-animate" data-aos="fade-up" data-aos-duration="700">
            <div class="lonyo-service-title">
        ...
        <div class="col-xl-4 col-lg-6 col-md-6">
          <div class="lonyo-service-wrap light-bg aos-init aos-animate" data-aos="fade-up" data-aos-duration="900">
            <div class="lonyo-service-title">
